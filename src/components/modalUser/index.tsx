...
interface Props {
    isOpen: boolean;
    onClose: () => void;
    userData: {fistName?: string, lastName?: string, email?: string, address?: string, zipCode?: string, city?: string};
}
...
const ModalUser = ({onClose, isOpen, userData} : Props) => {
    ...
    const [valide, setValide] = useState(false);
        ...
        const { firstName = '', lastName = '', email = '', address = '', zipCode = '', city = '' } = userData;
