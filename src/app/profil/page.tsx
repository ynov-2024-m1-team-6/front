            ...
            <div className="min-h-scren w-4/5 bg-gray-100 p-6">
                ...
                <div className="flex flex-row items-center h-[100px] gap-x-6 w-4/5 p-3">
                    ...
                    <div className="flex flex-col justify-center  gap-y-2">
                        ...
                        <p className="text-sm font-bold italic flex justify-items-start">Username</p>
                    </div>
                    <button className="bg-black hover:bg-white text-white hover:text-black border-black font-bold py-2 px-4 rounded flex ml-8">Edit Profil</button>
              ...
              <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                  ...
                  <div className="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                        <svg className="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
              ...
              <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                  ...
                  <div className="relative">
                  <div className="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                        <svg className="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <div className="w-full px-3 mt-6">
                  ...
                  <div className="relative">
                  <div className="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                        <svg className="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
